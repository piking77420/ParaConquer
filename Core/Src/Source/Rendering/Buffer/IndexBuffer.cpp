...
PC_CORE::IndexBuffer::IndexBuffer(uint8_t* _indicies, size_t _count, PC_CORE::MemoryLocalisation _memoryLocalisation, MemoryUsage _memoryUsageFlag)
{
...
PC_CORE::IndexBuffer::IndexBuffer(uint16_t* _indicies, size_t _count, PC_CORE::MemoryLocalisation _memoryLocalisation, MemoryUsage _memoryUsageFlag)
{
...
PC_CORE::IndexBuffer::IndexBuffer(uint32_t* _indicies, size_t _count, PC_CORE::MemoryLocalisation _memoryLocalisation, MemoryUsage _memoryUsageFlag)
{
