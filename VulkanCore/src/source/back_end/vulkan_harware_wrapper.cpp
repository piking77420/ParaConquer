...
vk::Result VK_NP::VulkanHarwareWrapper::CreateDebugUtilsMessengerEXT(vk::Instance _instance,
...
void VK_NP::VulkanHarwareWrapper::DestroyDebugUtilsMessengerEXT(vk::Instance _instance,
                                                                vk::DebugUtilsMessengerEXT* pDebugMessenger,
                                                                const vk::AllocationCallbacks* pAllocator)
{
