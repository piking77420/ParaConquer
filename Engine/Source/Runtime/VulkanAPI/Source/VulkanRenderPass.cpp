...
std::pair<vk::AccessFlags, vk::PipelineStageFlags> VulkanRenderPass::AttachementDependencies(const PC_CORE::RhiResource::State _State, [[maybe_unused]] const PC_CORE::RenderPassAttachementDescriptor& RenderPassAttachementDescriptor)
{
    PERF_REGION_SCOPED;
    PERF_REGION_COLOR(PerfRegion::Rhi);
