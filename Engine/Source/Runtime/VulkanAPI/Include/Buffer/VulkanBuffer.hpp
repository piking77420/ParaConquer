...
namespace Vulkan
{
    ...
    public:
        ...
        VulkanBuffer(const void* _data, uint32_t _sizeInByte, vk::BufferUsageFlags bufferUsage,
                     PC_CORE::MemoryLocalisation _visibility, PC_CORE::MemoryUsage memoryUsage);

        VulkanBuffer(uint32_t _sizeInByte, vk::BufferUsageFlags bufferUsage, PC_CORE::MemoryLocalisation _visibility,
                     PC_CORE::MemoryUsage memoryUsage);
    ...
    private:
        void CreateInternalBuffer(const void* _data, uint32_t _size, vk::BufferUsageFlags bufferUsage,
