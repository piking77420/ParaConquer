...
#else
#define VK_CHECK_CALL(x) if constexpr (ENABLE_VALIDATION_LAYERS) VulkanCheckErrorStatus(x, __LINE__, FUNCTION_NAME, FILENAME)
#endif


    static bool VulkanCheckErrorStatus(vk::Result _x, int _lign, const char* _func, const char* _file)
    {
