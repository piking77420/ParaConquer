...
BEGIN_PCCORE
    ...
    public:
        ...
        PC_FORCE_INLINE ComponentTypeBit GetComponentTypeBit() const
        {
            ...
            assert(
                m_ComponentTypeToComponentBitFlag.contains(componentTypeId) && "There is no component has this type");
        ...
        {
            assert(m_ComponentTypeToComponentBitFlag.contains(id) && "There is no component has this type");
        ...
        {
            assert(m_ComponentTypeToComponentBitFlag.contains(componentType) && "There is no component has this type");
