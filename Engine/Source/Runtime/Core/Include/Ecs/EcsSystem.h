...
BEGIN_PCCORE
    ...
    public:
        ...
        PC_CORE_API ~EcsSystem() override = default;
        ...
        PC_CORE_API void OnEntityDestroy(EntityId id, const Signature& _signature)
        {
        ...
        PC_CORE_API PC_FORCE_INLINE void OnEntitySignatureChange(EntityId id, const Signature& _old,
                                                                 const Signature& _new)
        {
            {
                // delete
