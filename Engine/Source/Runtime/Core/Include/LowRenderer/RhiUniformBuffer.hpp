...
BEGIN_PCCORE
    ...
    public:
        ...
        PC_CORE_API RhiUniformBuffer(size_t _sizeInByte, MemoryLocalisation _localisation,
                                     MemoryUsage memoryUsage) : RhiBuffer(_sizeInByte, _localisation, memoryUsage)
        {
        }
        ...
        PC_CORE_API ~RhiUniformBuffer() override = default;
