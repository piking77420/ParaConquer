...
SwapChainSupportDetails VK_NP::VulkanPhysicalDevices::QuerySwapChainSupport(const vk::PhysicalDevice _physicalDevice, const vk::SurfaceKHR _surface)
{
...
void VK_NP::VulkanPhysicalDevices::ChoosePhysicalDevice(const vk::Instance _instance, const vk::SurfaceKHR _SurfaceKHR, std::vector<const char*> _deviceExtensions)
{
